...
#ifndef __Ambverb__FDN__
#define __Ambverb__FDN__
...
public:
    ...
    void refreshWindow();
    int getMinDelaytime(){return minDelaytime;};
    int getMaxDelaytime(){return maxDelaytime;};
...
#endif /* defined(__Ambverb__FDN__) */
